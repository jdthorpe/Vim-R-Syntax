...
"       r_package_utils
"
" For highlighting additional package functions:
"       r_package_other
"
...
if exists("r_package_all") && r_package_all != 0
  ...
  if !exists("r_package_other")
    let r_package_other = 1
  endif
endif
...
if exists("r_package_other") && r_package_other != 0
  syn keyword rPackageFuns vimSyntax
endif
